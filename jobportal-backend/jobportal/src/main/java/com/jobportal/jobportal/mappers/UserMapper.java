...
public interface UserMapper {
    ...
    CurrentUserCandidateDTO toCurrentUserCandidateResponse(Candidate candidate, String userType);
    ...
    @Mapping(target = "userType", expression = "java(userType)")
    CurrentUserCompanyDTO toCurrentUserCompanyResponse(Company company, String userType);
